...
const ProductViewer = () => {
  ...
  return (
    <section id="product-viewer" className="h-fit lg:h-[80vh]">
      <h1 className>Take a closer look.</h1>
      ...
      <Canvas id="canvas-canvas" camera={{position: [0,2,5], fov: 50, near: 0.1, far:100}}>
